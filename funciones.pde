...
void estados(){
  ...
  if (contador >= height + 700){
    ...
    if(numPantalla == 0){
      ...
      FuncionParaPantallas5(numPantalla, opacidad);
    }
...
void FuncionParaPantallas5(int numeroDePantallas, float opacidadu){
  ...
  pushStyle();
    ...
    fill(255, opacidadu);
    println("numero de pantallas:", numeroDePantallas);
    text(texto5,posInicialEnXTexto,posInicialEnYTexto - contador + 80);
